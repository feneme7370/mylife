<div class="w-full">
    ...
    link_2="{{ route('media_dashboard') }}" title_3="Colecciones" link_3="{{ route('media_collection_list') }}" />
    ...
    <ul role="list" class="divide-y divide-purple-200 ">
        ...
        <li class="py-3 sm:py-4 w-full">
            <div class="flex items-center justify-between gap-2">
                    ...
                    <a href="{{ route('media_library', ['c' => $item->uuid]) }}" class="bg-purple-900 text-purple-50 text-xs font-medium me-2 px-2.5 py-0.5 rounded-lg">
                        {{ $item->medias->count() }}
                    </a>
    ...
    <form wire:submit="saveCollectionCreate" class="sm:m-3 p-4 bg-white border border-purple-200 rounded-lg shadow-sm sm:p-8  ">
        ...
        <div>
          ...
          <div class="col-span-12">
            <x-pages.forms.label-form for="cover_image_url" value="{{ __('URL del collection') }}" />
            <x-pages.forms.input-form id="cover_image_url" type="text" placeholder="{{ __('URL del collection') }}" wire:model="cover_image_url"
                  />
...
<x-slot name="content">
    <form wire:submit="deleteCollection" class="sm:m-3 p-4 bg-purple-50 border border-purple-200 rounded-lg shadow-sm sm:p-8  text-center">
        ...
        <p class="mb-5">Desea borrar el collection?</p>
