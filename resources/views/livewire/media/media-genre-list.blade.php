                    ...
                    <div class="flex items-center justify-between gap-2">
                            ...
                            <div class="">
                                <p class="text-sm font-medium text-gray-900 truncate ">
                                    <a class="hover:underline" href="{{ route('media_library', ['g' => $item->uuid]) }}">{{ $item->name }}</a>
                                </p>
                            </div>

                            <a href="{{ route('media_library', ['g' => $item->uuid]) }}" class="bg-purple-900 text-purple-50 text-xs font-medium me-2 px-2.5 py-0.5 rounded-lg">
                                {{ $item->medias->count() }}
                            </a>
