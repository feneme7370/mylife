<div class="w-full">
    ...
    link_2="{{ route('recipe_dashboard') }}" title_3="Editar {{ App\Models\Recipe::title() }}" link_3="{{ route('recipe_list') }}" />

<x-pages.menus.title-and-btn>

    @slot('title')
    <x-pages.titles.title-pages title="Editar {{ App\Models\Recipe::title() }}" />
    @endslot
