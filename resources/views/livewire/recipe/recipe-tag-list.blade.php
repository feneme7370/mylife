<div class="w-full">
    ...
    link_2="{{ route('recipe_dashboard') }}" title_3="Etiquetas" link_3="{{ route('recipe_tag_list') }}" />
            ...
            <div class="flex items-center justify-between gap-2">
                    ...
                    <div class="">
                        <p class="text-sm font-medium text-gray-900 truncate ">
                            <a class="hover:underline" href="{{ route('recipe_list', ['t' => $item->uuid]) }}">{{ $item->name }}</a>
                        </p>
                    </div>
...
<x-slot name="content">
    <form wire:submit="saveTagCreate" class="sm:m-3 p-4 bg-white border border-purple-200 rounded-lg shadow-sm sm:p-8  ">
...
<x-slot name="content">
    <form wire:submit="saveTagEdit" class="sm:m-3 p-4 bg-white border border-purple-200 rounded-lg shadow-sm sm:p-8  ">
   <div>
    <x-pages.forms.label-form for="name" value="{{ __('Nombre') }}" />
    <x-pages.forms.input-form id="name" type="text" placeholder="{{ __('Nombre') }}" wire:model="name"
          />
...
<x-slot name="content">
    <form wire:submit="deleteTag" class="sm:m-3 p-4 bg-purple-50 border border-purple-200 rounded-lg shadow-sm sm:p-8  text-center">
        
        <p class="mb-5">Desea borrar el tag?</p>
