...
class MediaCollectionList extends Component
{
    ...
    public function rules(){
        return [
            'name' => ['required', 'string', \Illuminate\Validation\Rule::unique('media_collections', 'name')->ignore($this->media_collection->id ?? 0)],
            'slug' => ['required', 'string', \Illuminate\Validation\Rule::unique('media_collections', 'slug')->ignore($this->media_collection->id ?? 0)],
